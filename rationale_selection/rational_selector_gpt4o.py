...
def main():
    selector = RationalSelector(api_key=OPENAI_API_KEY)

    input_file = 'data/results/e_daic_transcript_experiment_2_id300-486_gpt-4o_20251003_213123.xlsx'
    output_file = 'data/results/e_daic_transcript_experiment_2_depression_gpt4o_generated_gpt4o_selected.xlsx'
